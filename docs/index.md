...
For more information visit the [CTConfig documentation](CTConfig.md)
From now on all features of the churchtools-api are available.

### Requests and Models

The whole churchtools-api client is build on top of the Requests and Models. [Requests](Requests.md) provide an
interface to specify your api call by adding filtering and sorting. [Models](Models.md) represent the data, that
...
Further information on [CTLog-Page](CTLog.md):
